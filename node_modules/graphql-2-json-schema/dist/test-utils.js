...
exports.todoSchemaAsJsonSchemaWithoutNullableArrayItems = exports.todoSchemaAsJsonSchema = exports.getTodoSchemaIntrospection = void 0;
const graphql_1 = require("graphql");
const lodash_1 = require("lodash");
const getTodoSchemaIntrospection = () => {
...
`);
    const result = graphql_1.graphqlSync(schema, graphql_1.getIntrospectionQuery());
    return {
        introspection: result.data,
        schema,
    };
};
exports.getTodoSchemaIntrospection = getTodoSchemaIntrospection;
...
exports.todoSchemaAsJsonSchemaWithoutNullableArrayItems = lodash_1.cloneDeepWith(exports.todoSchemaAsJsonSchema, (value, key, object, stack) => {
    if (key === 'items' &&
        lodash_1.isEqual(Object.keys(value), ['anyOf']) &&
        value.anyOf.length === 2 &&
        value.anyOf.find((e) => lodash_1.isEqual(e, { type: 'null' }))) {
        return value.anyOf.find((e) => !lodash_1.isEqual(e, { type: 'null' }));
    }
});
